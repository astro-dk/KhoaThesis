...
\begin{equation}
    G_{00} = -\exp(-2W/c^2) \quad {\rm and}\qquad G_{0a} = - \frac{4}{c^3} W_a,\ a=1,2,3.
		\label{eq3.11}
\end{equation}
...
\begin{equation}
    E_a = \partial_a W + \frac{4}{c^2} \partial_t W_a,\qquad {\rm and}\qquad  
		B_a = \epsilon_{abc}\partial_b(-4W_c),\ a,b,c=1,2,3. \label{eq3.12}
\end{equation}
